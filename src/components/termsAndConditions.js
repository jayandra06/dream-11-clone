...
function TermsAndConditions() {
  return (
    <div className="term-and-condition">
      <h1>Wonderwin Terms and Conditions</h1>

      <p>
        Welcome to www.wonderwin.leonxtgentech.com ! These Terms and Conditions ("Terms")
      ...
      <ol>
        ...
        <li>
          ...
          <p>
            ...
            contact us at
            {' '}
            <a href="mailto:support@leonxtgentech.com">support@leonxtgentech.com</a>
            .
          </p>
        </li>
      </ol>
